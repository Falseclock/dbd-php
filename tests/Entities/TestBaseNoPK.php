...
class TestBaseNoPK extends Entity implements FullEntity
{
	const SCHEME = "public";
	const TABLE  = "test_base_entity";
	/**
	 * @var int $id
	 * @see TestBaseNoPKMap::$id
	 */
	public $id;
	/**
	 * @var string $name
	 * @see TestBaseNoPKMap::$name
	 */
	public $name;
}

class TestBaseNoPKMap extends Mapper implements FullMapper
{
